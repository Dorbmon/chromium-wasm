...
// memory-leak freedom, persistence, or a release-ready M9 gate.
const HOST_PROTOCOL = 1;
const CASE = "browser_repeating_timer_m9";
const SCOPE = "fixed-three-native-ui-repeating-timer-ticks-with-host-event-loop-and-post-shutdown-quiet-observation";
...
export async function runChromeWasmBrowserM9RepeatingTimerSmokeFromQuery() {
  ...
  const host = new ChromiumWasmBrowserM9RepeatingTimerSmokeHost(canvas, versions);
