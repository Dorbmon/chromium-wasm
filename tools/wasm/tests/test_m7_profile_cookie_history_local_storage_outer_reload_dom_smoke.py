...
"""Focused contracts for the aggregate Cookie + History + LocalStorage reload runner."""
...
import run_m7_chrome_profile_cookie_history_local_storage_outer_reload_dom_smoke as smoke
...
class M7ProfileCookieHistoryLocalStorageOuterReloadDomSmokeTest(unittest.TestCase):
    def test_uses_a_dedicated_two_document_aggregate_artifact(self) -> None:
        ...
        self.assertEqual(
            ...
            Path("out/wasm-chrome-m7-profile-cookie-history-local-storage"),
        )
    ...
    def test_host_and_runner_never_use_host_profile_storage_or_self_navigation(self) -> None:
        host = (
            TOOLS_DIR
            / "host"
            / "chrome_wasm_profile_cookie_history_local_storage_outer_reload_smoke.js"
    ...
    def test_configuration_requires_the_aggregate_opt_in(self) -> None:
        smoke.validate_m7_output_configuration(
            b"enable_chromium_wasm_m7_profile_cookie_history_local_storage_test=true\n"
        )
        for invalid in (
            b"",
            b"enable_chromium_wasm_m7_profile_cookie_history_local_storage_test=false\n",
        ):
